...
function TeamList() {
  return teamList.map((team, i) => <Team key={i} {...team} />);
}
...
const teamList = [
  {
    id: 0,
    player1: "Lazar Trifunovic",
    player2: "Milica Jovanovic",
  },
  {
    id: 1,
    player1: "Dusan Velickovic",
    player2: "Nikola Popovic",
  },
  {
    id: 2,
    player1: "Veljko Jaksic",
    player2: "Mihajlo Dincic",
  },
  {
    id: 3,
    player1: "Josif Kostic",
    player2: "Sava Stankovic",
  },
];

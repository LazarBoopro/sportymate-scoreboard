    ...
    return (
        <>
            ...
            <article className="tournament">
                {t ? (
                    Object.values(groups)?.map((n: any, i: number) => <Group key={i} {...n} />)
                ) : (
...
function Graph({ tournament }: { tournament: any }) {
    ...
    function getTeams(phase: string, slice1: number, slice2: number, arrLen: number) {
    ...
    return (
        <section className="graph">
            ...
            <div className="sixteen-finals left group">{getTeams("round-of-16", 0, 2, 4)}</div>

            <div className="quarter-finals left group">{getTeams("quarter-finals", 0, 1, 2)}</div>

            <div className="semi-finals left group">{getTeams("semi-final", 0, 1, 1)}</div>
            ...
            <div className="semi-finall right group">{getTeams("semi-final", 1, 2, 1)}</div>

            <div className="quarter-finals right group">{getTeams("quarter-finals", 1, 2, 2)}</div>

            <div className="sixteen-finals right group">{getTeams("round-of-16", 2, 4, 4)}</div>
        </section>
    );
}

...
export const addGroup = (data: GroupType, tournamentId: string, groupId: string, phase: string) => {
...
export const updateGroup = async ({
    ...
    update(ref(database, `tournaments/${tournamentId}/matches/${phase}/${groupId}`), data);
};

...
export default function useMatches() {
    ...
    const { mutate: addTournament, isSuccess, isPending: isAddingTournament } = useAddMatch();

    const [tournaments, setTournaments] = useState<TournamentTypeExtended[] | null>(null);
    const [isDouble, setIsDouble] = useState(true);
    const [isSuperTieBreak, setIsSuperTieBreak] = useState(MATCH_DEFAULT_OPTIONS.superTieBreak);
    ...
    useEffect(() => {
        ...
        const tournamentQuery = query(tournamentsRef, orderByChild("userId"), equalTo(user?.uid));
